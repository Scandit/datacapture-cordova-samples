...
import { BarcodeCaptureSymbologyForm } from 'src/app/models';
...
export class SymbologyComponent extends SettingsBase implements OnInit {
  ...
  public form: BarcodeCaptureSymbologyForm;
  ...
  public ngOnInit() {
    ...
    this.form = this.settingsService.symbologiesForm.controls[this.symbology] as BarcodeCaptureSymbologyForm;
