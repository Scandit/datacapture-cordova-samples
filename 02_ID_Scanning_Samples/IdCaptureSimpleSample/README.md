...
This sample demonstrates the basic functionality of the ID Capture API. It shows how to scan and extract data from identity documents such as passports, driver's licenses, and ID cards.
